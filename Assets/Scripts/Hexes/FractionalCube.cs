...
public struct FractionalCube {
    ...
    public static explicit operator CubeHex(FractionalCube a) {
        return a.GetRounded();
    }
    ...
    public static FractionalCube FromCartesian(Vector2 position) {
        float q = _XQ*position.x;
        float r = _XR*position.x + _YR*position.y;
        return new FractionalCube(q, r, -q - r);
    }

    public Vector2 GetPosition() {
        return new Vector2(_QX*_q, _QY*_q + _RY*_r);
    }
}
